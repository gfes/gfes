...
class ConfigableTaskWrapper {
    ...
    makeStream(callback) {
        if (typeof callback === "function") {
            this.makeStreamResultFn = ()=>callback.call(this, this.options);
            this.pipeline = (fn)=>{
    ...
    get stream(){
        if(!this.makeStreamResult){
            this.makeStreamResult = this.makeStreamResultFn();
        }
        return this.makeStreamResult
    }
}
